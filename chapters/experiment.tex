...
\begin{figure*}
  \centering
  \includegraphics[width=\plotwidth]{matplotlib/other/lumivstime}
...
% \begin{figure*}[!htbp]
%   \centering
%   \subbottom[Transverse view]{\includegraphics[width=0.35\textwidth]{figures/cms-xsection-trans.pdf}\label{cms-xsection-trans}}
%   \subbottom[Longitudinal view]{\includegraphics[width=0.65\textwidth]{figures/cms-xsection-long.pdf}\label{cms-xsection-long}}
