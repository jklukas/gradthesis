...
\begin{figure*}[p]
  ...
  \newcommand{\mygraph}[1]{\includegraphics[width=0.49\textwidth]{matplotlib/leptoncuts/#1}}
...
\begin{figure}
  \centering
  \includegraphics[width=\plotwidth]{matplotlib/analysis/hZMass_ValidW}
...
\begin{figure}
  \centering
  \includegraphics[width=\plotwidth]{matplotlib/analysis/hMET_ValidW}
...
\begin{figure}
  \centering
  \includegraphics[width=\plotwidth]{matplotlib/analysis/hWTransMass_ValidW}
...
\begin{figure}
  \centering
  \includegraphics[width=\plotwidth]{matplotlib/analysis/hHt_ValidWZCand}
...
\begin{figure}
  \centering
  \includegraphics[width=\plotwidth]{matplotlib/analysis/hWZMass_ValidWZCand}
